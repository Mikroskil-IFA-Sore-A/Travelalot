        ...
        countries: {
            egypt: {
                ...
                cuisines: [
                    ...
                    {
                        name: 'Hummus',
                        desc: 'A smooth and creamy dip or spread made from mashed chickpeas blended with tahini (sesame paste), garlic, and olive oil. Typically served with pita bread or as an accompaniment.',
            ...
            southafrica: {
                ...
                cuisines: [
                    {
                        name: 'Shakshuka',
                        desc: 'North African dish consisting of poached eggs in a savory, spiced tomato and bell pepper sauce, often seasoned with cumin, paprika, and garlic.',
            ...
            morroco: {
                ...
                cuisines: [
                    ...
                    },
                    {
                        ...
                        desc: 'A vibrant and colorful platter of various cooked and raw vegetable salads, beautifully arranged around a center of rice or tuna.',
            ...
            tunisia: {
                ...
                cuisines: [
                    ...
                    {
                        name: 'Rozz Jerbi',
                        desc: 'A traditional steamed rice dish from the island of Djerba, mixed with finely chopped vegetables, spices, and meat or liver, steamed together in a couscoussier.',
        ...
        countries: {
                ...
                cuisines: [
                    {
                        ...
                        desc: 'A rich and dense dessert made with cream cheese for a smooth, velvety texture, typically served on a graham cracker crust and topped with a vibrant strawberry glaze.',
            ...
            sf: {
                ...
                cuisines: [
                    {
                        name: 'Cioppino',
                        desc: 'An Italian-American seafood stew made from the "catch of the day"—simmered in a savory tomato and wine broth.',
                ...
                cuisines: [
                    {
                        ...
                        desc: 'A Toronto classic consisting of lean, cornmeal-crusted back bacon slices grilled and served on a soft kaiser roll.',
        ...
        countries: {
            china: {
                ...
                cuisines: [
                    {
                        name: 'Hong Shao Rou',
                        desc: 'Succulent cubes of pork belly slow-cooked in a rich glaze of soy sauce, sugar, and aromatic spices until the meat is tender and coated in a deep, caramelized red sauce.',
                        image: imageIndex.asia?.china?.cuisines?.[0]
                    },
                    {
                        name: 'Sheng Jian Bao',
                        desc: 'Yeasted buns filled with minced pork and gelatin that melts into broth, pan-fried in a skillet to create a crispy, golden-brown bottom while the tops are steamed.',
                        image: imageIndex.asia?.china?.cuisines?.[1]
                    },
                    {
                        name: 'Xiao Long Bao',
                        desc: 'Delicate, hand-pleated dumplings filled with a savory pork morsel and a pocket of hot, flavorful broth, steamed and served in bamboo baskets.',
                ...
                cuisines: [
                    {
                        ...
                        desc: 'Vibrant Balinese platter featuring steamed rice with side dishes, most notably Babi Guling (roast suckling pig), served on a traditional banana leaf.',
                        image: imageIndex.asia?.indonesia?.cuisines?.[0]
                    },
                    {
                        name: 'Nasi Campur',
                        desc: 'A foundational Indonesian meal consisting of a scoop of white rice surrounded by a diverse array of side dishes, all brought together by a dollop of spicy sambal.',
                        image: imageIndex.asia?.indonesia?.cuisines?.[1]
                    },
                    {
                        name: 'Sate Lilit',
                        desc: 'A unique dish made from minced meat (fish, chicken, or pork) and a complex spice paste, then wrapped around lemongrass stalks and grilled over charcoal.',
                        image: imageIndex.asia?.indonesia?.cuisines?.[2]
                    },
                    {
                        name: 'Sate Lilit with Sambal Matah',
                        desc: 'Savory minced meat skewers grilled on lemongrass sticks, served with Sambal Matah, a famous Balinese raw condiment.',
            ...
            japan: {
                ...
                cuisines: [
                    {
                        name: 'Ramen',
                        desc: 'A world famous noodle soup consisting of wheat noodles served in a savory broth, topped with sliced chashu pork, a soft-boiled marinated egg, nori, and bamboo shoots.',
                        image: imageIndex.asia?.japan?.cuisines?.[0]
                    },
                    {
                        name: 'Sushi Platter',
                        desc: 'Elegant assortment of vinegared rice topped with fresh slices of raw seafood like salmon and tuna (nigiri).',
                        image: imageIndex.asia?.japan?.cuisines?.[1]
                    },
                    {
                        name: 'Tempura',
                        desc: 'A classic Japanese dish consisting of seafood and vegetables, lightly battered and deep-fried to crispness, usually served with a dashi-based dipping sauce.',
            ...
            malaysia: {
                ...
                cuisines: [
                    {
                        name: 'Char Kway Teow',
                        desc: 'A smoky and savory stir-fried flat rice noodle dish cooked over high heat, flavored with a blend of soy sauces and chili paste.',
                        image: imageIndex.asia?.malaysia?.cuisines?.[0]
                    },
                    {
                        name: 'Nasi Lemak',
                        desc: 'A Malaysian staple, featuring fragrant rice cooked in coconut milk and pandan leaf, served with sambal, crispy anchovies, toasted peanuts, and a hard-boiled egg.',
                        image: imageIndex.asia?.malaysia?.cuisines?.[1]
                    },
                    {
                        name: 'Satay with Peanut Sauce',
                        desc: 'Succulent skewers of marinated meat, grilled over charcoal until charred and smoky, traditionally served with a peanut dipping sauce.',
                ...
                cuisines: [
                    {
                        ...
                        desc: 'Sweet, glutinous rice steamed with coconut milk and sugar, served alongside fresh mango slices and topped with a salty-sweet coconut cream sauce and toasted mung beans.',
                        image: imageIndex.asia?.thailand?.cuisines?.[0]
                    },
                    {
                        name: 'Vegetarian Pad Thai',
                        desc: 'Stir-fried rice noodles tossed with tofu, bean sprouts, and green onions in a tangy tamarind-based sauce, garnished with crushed peanuts and fresh lime.',
                        image: imageIndex.asia?.thailand?.cuisines?.[1]
                    },
                    {
                        name: 'Pad Thai with Shrimp',
                        desc: 'Thailand`s iconic stir-fried noodle dish, combining rice sticks with plump shrimp, eggs, and firm tofu in a sweet-savory sauce.',
                        image: imageIndex.asia?.thailand?.cuisines?.[2]
                    },
                    {
                        name: 'Tom Yum Goong',
                        desc: 'A hot and sour Thai soup characterized by its fragrant broth, loaded with succulent shrimp, mushrooms, and a spicy chili kick.',
        ...
        countries: {
            france: {
                ...
                cuisines: [
                    {
                        name: 'Ratatouille',
                        desc: 'A traditional French Provençal stewed vegetable dish, seasoned with garlic and herbes de Provence for a rich, earthy flavor.',
                        image: imageIndex.europe?.france?.cuisines?.[0]
                    },
                    {
                        name: 'Macarons',
                        desc: 'Colorful confections featuring a smooth top, a ruffled "foot," and a creamy ganache, buttercream, or jam filling sandwiched between two shells.',
            ...
            germany: {
                ...
                cuisines: [
                    {
                        name: 'Sauerbraten',
                        desc: 'Traditional German pot roast of heavily marinated meat, served with a thick sweet-and-sour gravy, accompanied by red cabbage and potato dumplings.',
                        image: imageIndex.europe?.germany?.cuisines?.[0]
                    },
                    {
                        name: 'Bitburger Pilsner',
                        desc: 'A premier German pilsner beer characterized by its bright golden color, a delicate hoppy aroma, and a crisp, clean finish that is iconic to the Eifel region.',
            ...
            netherlands: {
                ...
                cuisines: [
                    {
                        name: 'Hachee',
                        desc: 'A traditional Dutch stew made with diced beef, fish, or poultry and caramelized onions, slow-cooked in a thick gravy, and typically served with mashed potatoes and red cabbage.',
                ...
                cuisines: [
                    {
                        ...
                        desc: 'A family of confections based on a gel of starch and sugar, frequently packed with chopped pistachios, hazelnuts, or walnuts, then dusted with icing sugar.',
                        image: imageIndex.europe?.turkey?.cuisines?.[0]
                    },
                    {
                        name: 'Ali Nazik Kebab',
                        desc: 'A delicious Ottoman-style dish featuring smoked and spiced grilled lamb or beef, served over a bed of eggplant purée mixed with garlic yogurt and drizzled with melted butter.',
            ...
            uk: {
                ...
                cuisines: [
                    {
                        name: 'Fish and Chips',
                        desc: 'A classic British comfort dish consisting of a fresh white fish fillet coated in a crispy batter, deep-fried and served alongside thick-cut potato chips and tartar sauce.',
                        image: imageIndex.europe?.uk?.cuisines?.[0]
                    },
                    {
                        name: 'Full English Breakfast',
                        desc: 'A substantial morning meal featuring fried eggs, sausages, back bacon, fried bread, and baked beans, often accompanied by black pudding and hash browns.',
        ...
        countries: {
            australia: {
                ...
                cuisines: [
                    ...
                    },
                    {
                        ...
                        desc: 'A fresh and vibrant contemporary Australian salad featuring avocado, white beans, and cherry tomatoes, seasoned with fresh herbs and a light citrus vinaigrette.',
            ...
            fiji: {
                ...
                cuisines: [
                    ...
                    {
                        name: 'Lovo',
                        desc: 'A traditional Fijian feast where meat, seafood, and root vegetables are slow-cooked in an underground earth oven over hot stones and covered with banana leaves.',
